...
const HomePage = () => {
  return (
    <div>
      ...
      <p>Pokud Vás napadá otázka, nejprve se podívejte, jestli podobný nebo stejný problém neměl už někdo před Vámi.</p>
      <p>Archiv všech zodpovězených dotazů najdete na stránce Archiv dotazů.</p>
      <p>Pokud Váš problém, zatím nikdo neřešil, neváhejte se zeptat. Před položením dotazu se prosím registrujte/přihlaste do aplikace.</p>
      ...
      <p>V Harro Naturo používáme přírodní barvy na vlasy profesionálně již 10 let. Máme za sebou desetitisíce barvení na tisících různých vlasů a víme, co tyto barvy umí, i co neumí.</p>
    </div>
  );
};
